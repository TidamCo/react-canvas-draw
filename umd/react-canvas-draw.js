...
var _LazyBrush = __webpack_require__(9);
...
var _Catenary = __webpack_require__(10);
...
function interactionStateMachine_defineProperty(obj, key, value) { key = interactionStateMachine_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function interactionStateMachine_toPropertyKey(t) { var i = interactionStateMachine_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
function interactionStateMachine_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
var TOUCH_SLOP = 10;
...
var ScaleOrPanState = function ScaleOrPanState() {
  ...
  interactionStateMachine_defineProperty(this, "handleDrawMove", function (e, canvasDraw) {
    ...
    var _this6$recentMetrics = _this6.recentMetrics = _this6.getTouchMetrics(e),
      ...
      distance = _this6$recentMetrics.distance;
...
function src_toPropertyKey(t) { var i = src_toPrimitive(t, "string"); return "symbol" == typeof i ? i : String(i); }
...
var src_CanvasDraw = /*#__PURE__*/function (_PureComponent) {
  ...
  function CanvasDraw(props) {
    ...
    src_defineProperty(_assertThisInitialized(_this), "handleWheel", function (e) {
      var tmpInterationSM = _this.interactionSM.handleMouseWheel(e, _assertThisInitialized(_this));
      if (tmpInterationSM !== undefined) {
        _this.interactionSM = tmpInterationSM;
      }
    });
